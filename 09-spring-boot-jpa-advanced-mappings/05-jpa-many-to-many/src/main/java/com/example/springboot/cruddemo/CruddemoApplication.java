...
import com.example.springboot.cruddemo.entity.*;
...
//			deleteCourse(appDAO);
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		//add some students
		tempCourse.addStudent(new Student("John", "Doe", "john@gmail.com"));
		tempCourse.addStudent(new Student("Mary", "Public", "mary@gmail.com"));
